...
var TROOP_NAMES = [
  [{arrows: 1, height: 1e48},"Chuck Norrises"],
  [{arrows: 1, height: 1e31},"Elder Gods"],
  [{arrows: 1, height: 1e25},"Inter Dymensional Beings"],
  [{arrows: 1, height: 1e18},"Celestial Forces"],
  [{arrows: 1, height: 1e10},"Death Stars"],
  [{arrows: 1, height: 1e7},"Titans"],
  [{arrows: 1, height: 1e3},"Fallen Angels"],
  [1e70,"Demon Lords"],
  [1e20,"Balrogs"],
  [5e8,"Archdemons"],
  [2e6,"Elder Dragons"],
...
var TROOP_ICONS = {
  ...
  "Titans": "icons/Titian.png",
  "Death Stars": "icons/Death Star.png",
  "Celestial Forces": "icons/Celestial Force.png",
  "Inter Dymensional Beings": "icons/Inter Dymensional Being.png",
  "Elder Gods": "icons/Elder God.png",
  "Chuck Norrises": "icons/Chuck Norris.png"
};
...
function getConditionEvents(G, tpFn, cntFn, ePctFn) {
  return [
    ...
    {cond:function(tn){return (tn||getTN()).startsWith("Thug")}, chance:0.05, msg:"Your thugs Gluff and Buff are feuding against each other.", random:true},
    ...
    {cond:function(tn){return (tn||getTN()).startsWith("Thug")}, chance:0.05, msg:"Your thug Tiel eats too much gruel for breakfast. Vomiting ensues.", random:true},

    // Soldiers
    {cond:function(tn){return (tn||getTN()).indexOf("Soldier")>=0}, chance:0.05, msg:"A soldier polishes his boots obsessively.", random:true},
    {cond:function(tn){return (tn||getTN()).indexOf("Soldier")>=0}, chance:0.05, msg:"The soldiers march in perfect formation.", random:true},
    {cond:function(tn){return (tn||getTN()).indexOf("Soldier")>=0}, chance:0.05, msg:"Your Thugs now show true discipline, like trained soldiers.", random:true},
    {cond:function(tn){return (tn||getTN()).indexOf("Soldier")>=0}, chance:0.05, msg:"The local governor cedes control of his province to you.", random:true},
    {cond:function(tn){return (tn||getTN()).indexOf("Soldier")>=0}, chance:0.05, msg:"Your soldiers now patrol the streets.", random:true},
    {cond:function(tn){return (tn||getTN()).indexOf("Soldier")>=0}, chance:0.05, msg:"Your soldiers face marauders from the east.", random:true},
    {cond:function(tn){return (tn||getTN()).indexOf("Soldier")>=0}, chance:0.05, msg:"6 surrounding cities have surrendered to your control.", random:true},
    {cond:function(tn){return (tn||getTN()).indexOf("Soldier")>=0}, chance:0.05, msg:"One of your soldiers gets married!", random:true},
    {cond:function(tn){return (tn||getTN()).indexOf("Soldier")>=0}, chance:0.05, msg:"Your soldiers now collect taxes from peasants to pay for their equipment.", random:true},
    {cond:function(tn){return (tn||getTN()).indexOf("Soldier")>=0}, chance:0.05, msg:"Your soldiers quash a peasant revolt.", random:true},
    {cond:function(tn){return (tn||getTN()).indexOf("Soldier")>=0}, chance:0.05, msg:"Neighboring emperors warn you not to encroach on their territory.", random:true},
    {cond:function(tn){return (tn||getTN()).indexOf("Soldier")>=0}, chance:0.05, msg:"Your soldiers train for 8 hours a day", random:true},
    {cond:function(tn){return (tn||getTN()).indexOf("Soldier")>=0}, chance:0.05, msg:"One of your soldiers trained for 14 hours a day.", random:true},
    


    // Knights
    {cond:function(tn){return (tn||getTN()).indexOf("Pikemen")>=0}, chance:0.05, msg:"Your Pikemen train in the Tercio formation.", random:true},
    {cond:function(tn){return (tn||getTN()).indexOf("Pikemen")>=0}, chance:0.05, msg:"Your Pikemen train in the Phalanx formation.", random:true},
    {cond:function(tn){return (tn||getTN()).indexOf("Pikemen")>=0}, chance:0.05, msg:"Your Pikemen train in the Sciltron formation.", random:true},
    {cond:function(tn){return (tn||getTN()).indexOf("Pikemen")>=0}, chance:0.05, msg:"Your Pikemen train in the Shield Wall formation.", random:true},
    {cond:function(tn){return (tn||getTN()).indexOf("Pikemen")>=0}, chance:0.05, msg:"Your Pikemen train in the Wedge formation.", random:true},
    {cond:function(tn){return (tn||getTN()).indexOf("Pikemen")>=0}, chance:0.05, msg:"Your Pikemen train in the Svinfylking formation.", random:true},

    {cond:function(tn){return (tn||getTN()).indexOf("Archers")>=0}, chance:0.05, msg:"Arrows rain down upon your enemies.", random:true},
    {cond:function(tn){return (tn||getTN()).indexOf("Archers")>=0}, chance:0.05, msg:"The sky is blackened from the arrows of your archers.", random:true},
    {cond:function(tn){return (tn||getTN()).indexOf("Archers")>=0}, chance:0.05, msg:"Your archers can hit a target 1000 yards away.", random:true},
    {cond:function(tn){return (tn||getTN()).indexOf("Archers")>=0}, chance:0.05, msg:"Your archers can hit a target 10,000 yards away.", random:true},
    {cond:function(tn){return (tn||getTN()).indexOf("Archers")>=0}, chance:0.05, msg:"Your archers train to hit a target while on horseback.", random:true},
    {cond:function(tn){return (tn||getTN()).indexOf("Archers")>=0}, chance:0.05, msg:"Your archers now carry swords too.", random:true},
    {cond:function(tn){return (tn||getTN()).indexOf("Archers")>=0}, chance:0.05, msg:"Your archers can kill two birds with one arrow.", random:true},
    {cond:function(tn){return (tn||getTN()).indexOf("Archers")>=0}, chance:0.05, msg:"Legend says your archers can hit a moving fly from 50,000 yards away.", random:true},
    {cond:function(tn){return (tn||getTN()).indexOf("Archers")>=0}, chance:0.05, msg:"Reports of your archers' prowess may be exaggerated.", random:true},

    {cond:function(tn){return (tn||getTN()).indexOf("Knight")>=0}, chance:0.05, msg:"A knight speaks of chivalry and honor.", random:true},
    {cond:function(tn){return (tn||getTN()).indexOf("Knight")>=0}, chance:0.05, msg:"The horses grow restless before battle.", random:true},
    {cond:function(tn){return (tn||getTN()).indexOf("Knight")>=0}, chance:0.05, msg:"70 Knights can conquer a city. A thousand can conquer the world.", random:true},
    {cond:function(tn){return (tn||getTN()).indexOf("Knight")>=0}, chance:0.05, msg:"Everyone wants to become one of your knights.", random:true},
    {cond:function(tn){return (tn||getTN()).indexOf("Knight")>=0}, chance:0.05, msg:"Your knights get new armor. Now in yellow!", random:true},
    {cond:function(tn){return (tn||getTN()).indexOf("Knight")>=0}, chance:0.05, msg:"'I can slay a dragon all by myself' boasts one of your knights.", random:true},
    {cond:function(tn){return (tn||getTN()).indexOf("Knight")>=0}, chance:0.05, msg:"Dragon? Shmragon! We can slay a Kragon, noooo problem say your knights.", random:true},
    {cond:function(tn){return (tn||getTN()).indexOf("Knight")>=0}, chance:0.05, msg:"Your knights request a sabbatical to go on a quest.", random:true},
    {cond:function(tn){return (tn||getTN()).indexOf("Knight")>=0}, chance:0.05, msg:"'Knights are just thugs on horses' claims Korg the bartender.", random:true},


    {cond:function(tn){return (tn||getTN()).indexOf("Swordsmen")>=0}, chance:0.05, msg:"Your Swordsmen train from the age of 7.", random:true},
    {cond:function(tn){return (tn||getTN()).indexOf("Swordsmen")>=0}, chance:0.05, msg:"Your Swordsmen train for 16 hours a day.", random:true},
    {cond:function(tn){return (tn||getTN()).indexOf("Swordsmen")>=0}, chance:0.05, msg:"Your weakest Swordsman has more skill than the Champion of Thebes.", random:true},
    {cond:function(tn){return (tn||getTN()).indexOf("Swordsmen")>=0}, chance:0.05, msg:"You fire your sword-trainer after he made his students fight to the death.", random:true},
    {cond:function(tn){return (tn||getTN()).indexOf("Swordsmen")>=0}, chance:0.05, msg:"New Rule: Practice sword matches can not be with real swords.", random:true},
    {cond:function(tn){return (tn||getTN()).indexOf("Swordsmen")>=0}, chance:0.05, msg:"'The sword chooses the swordsman' says crazed lunatic.", random:true},
